...
| Semantic contracts | R-CONTRACT-001..007 | CORE-v0.1 | docs 28, 29, 31, 69, 72, 76; capability/type/registry schemas; `0012`/`0014` persistence | #2, #17 | registry + semantic fixture validation; stamped guard repair fence, strict owner-bound current-generation re-attestation, terminal and unprovable-history denial, append-only activation identity and global legacy-scope containment |
...
| Security/authority | R-SEC-001..007 + R-AUTH-001..008 | CORE-v0.1 / CROSS-CUTTING | docs 08, 19, 21, 39, 77, 85, 91; authority/policy/grant contracts | #3, #11 | deterministic allow/deny/approval/grant + adversarial tests, including export-adapter destructor admission before success |
| Artifact/data | R-DATA-001..005 + R-ART-001..005 | CORE-v0.1 | docs 20, 35, 75, 85, 91; Artifact allocation/publication schemas; additive placement-receipt migration 0020 | #4, #5, #3 | content identity/staging/publication/lineage/crash tests; exact admitted-receipt promotion and denied/unreceipted restart tests |
...
| Provider execution | R-EXEC-001..009 | CORE-v0.1 | docs 78, 80, 82, 85; binding/invocation/profile contracts; provider state-epoch and binding-marker persistence guards | **#30** | bounded offline deterministic provider + malicious-provider tests; exact evidence, trust-source, contract, manifest, and build pins in new Stage-1 binding receipts; expiry checked at binding creation and enabled interval pinned across disable/re-enable |
| Persistence integrity | R-PERSIST-001..006 | CORE-v0.1 / CROSS-CUTTING | docs 35, 73–80, 85, 91; `persistence-v0.1.sql` and additive `0012`–`0020` | #1/#2/#4/#5/#3/#30 | transaction/idempotency/owner-fencing/privacy/crash-injection tests; immutable exact placement receipts; legacy pending files receive no migration grant |
| Recovery certainty | R-REC-001..011 | CORE-v0.1 / CROSS-CUTTING | docs 24, 74, 75, 80, 85, 86, 91; recovery contracts; migration 0020 | #11 + all core issues | crash/response-loss/private-entry/per-subject unknown-outcome tests; approved pending promotion versus denied and unreceipted private residue |
...
| Provenance | R-PROV-001..006, R-PERSIST-002/004/006, R-REC-008 | #5 | append/hash-chain/material action attribution; typed creation commitment and raw-intent legacy export rejection |
