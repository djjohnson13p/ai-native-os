...
| Provider execution | R-EXEC-001..009 | CORE-v0.1 | docs 78, 80, 82, 85; binding/invocation/profile contracts | **#30** | bounded offline deterministic provider + malicious-provider tests; exact evidence, trust-source, contract, manifest, and build pins in new Stage-1 binding receipts |
