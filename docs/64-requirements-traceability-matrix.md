...
| Persistence integrity | R-PERSIST-001..006 | CORE-v0.1 / CROSS-CUTTING | docs 35, 73–80, 85; `persistence-v0.1.sql` and additive `0012`–`0014` | #1/#2/#4/#5/#3/#30 | transaction/idempotency/owner-fencing/privacy/crash-injection tests; raw-intent legacy export rejection; clean/partial stamped semantic repair migration and immutable fence/terminal/receipt guards |
